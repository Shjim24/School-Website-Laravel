...
@section('content')
    ...
    <!-- =================================================================
         MODIFICATION: Auth Links Bar
         This bar is corrected to ensure all Blade directives are properly closed.
         ================================================================= -->
    <div style="background-color: #f8f9fa; padding: 0.5rem 1rem; text-align: right; border-bottom: 1px solid #dee2e6;">
        @auth
            {{-- If the user is logged in --}}
            <span>Welcome, {{ Auth::user()->name }}!</span>

            {{-- Show Admin Dashboard link if user has 'admin' or 'super-admin' role --}}
            @can('access-dashboard')
                <a href="{{ route('admin.dashboard') }}" style="text-decoration: none; margin-left: 15px;">Admin Dashboard</a>
            @endcan {{-- <-- Check for this closing tag --}} {{-- Show Manage Users link ONLY if user has 'super-admin' role
                --}} @can('manage-users') <a href="{{ route('admin.users.index') }}"
                    style="text-decoration: none; margin-left: 15px;">Manage Users</a>
                @endcan {{-- <-- Check for this closing tag --}} {{-- The logout link is available to all authenticated users
                    --}} <a href="{{ route('logout') }}"
        ...
        @else
                    ...
                    <a href="{{ route('login') }}" style="text-decoration: none; margin-left: 15px;">Log in</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" style="text-decoration: none; margin-left: 15px;">Register</a>
                @endif {{-- <-- Check for this closing tag --}} @endauth {{-- <-- And most importantly, check for this
                    closing tag --}} </div>
                            ...
                            <div class="hero-slider owl-carousel">
                                ...
                                <div class="hero-single-slide"
                                    ...
                                    <div class="hero-content">
                                        ...
                                        <div
                                            class="hero-btn-container animate__animated animate__fadeInUp animate__delay-2s">
                                            <a href="{{ url('/buildings') }}" class="hero-btn">সুবিধাদি দেখুন</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="notice-board">
                                ...
                                <div class="notice-content">
                                    <ul class="notice-list">
                                        <li class="notice-item">
                                            <div class="notice-info">
                                                ...
                                                <div class="notice-text-wrapper">
                                                    <span class="notice-text">আগামীকাল মহান স্বাধীনতা দিবস উপলক্ষে স্কুল এবং
                                                        কলেজ বন্ধ
                                                        থাকবে</span>
                                        ...
                                        <li class="notice-item">
                                            <div class="notice-info">
                                                <i class="fas fa-bell notice-icon"></i>
                                                <div class="notice-text-wrapper">
                                                    <span class="notice-text">২০২৪ ভর্তি সংক্রান্ত জরুরি বিজ্ঞপ্তি!</span>
                                        ...
                                        <li class="notice-item">
                                            <div class="notice-info">
                                                <i class="fas fa-bell notice-icon"></i>
                                                <div class="notice-text-wrapper">
                                                    <span class="notice-text">সবক্লাসের ১ম সেমিস্টার পরীক্ষার রুটিন</span>
                                        ...
                                        <li class="notice-item">
                                            <div class="notice-info">
                                                <i class="fas fa-bell notice-icon"></i>
                                                <div class="notice-text-wrapper">
                                                    <span class="notice-text">বেতন সংক্রান্ত জরুরি বিজ্ঞপ্তি!</span>
                                        ...
                                        <li class="notice-item">
                                            <div class="notice-info">
                                                <i class="fas fa-bell notice-icon"></i>
                                                <div class="notice-text-wrapper">
                                                    <span class="notice-text">পহেলা বৈশাখ উপলক্ষে আগামীকাল স্কুল ও কলেজ বন্ধ
                                                        থাকবে</span>
                                    ...
                                    <div class="notice-footer">
                                        <a href="{{ url('/notices') }}" class="view-all-btn">সকল নোটিশ দেখুন <i
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="quick-link-box compact-box">
                                        ...
                                        <ul class="box-links">
                                            ...
                                            <li>
                                                <a href="{{ url('/school-information') }}">সাফল্য ও অর্জন</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/management-committee') }}">ব্যবস্থাপনা কমিটি</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/approved-positions') }}">আসন সংখ্যা</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="quick-link-box compact-box">
                                        ...
                                        <ul class="box-links">
                                            ...
                                            <li>
                                                <a href="{{ url('/current-students') }}">ছাত্রছাত্রীদের তালিকা</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/student-attendance') }}">শিক্ষার্থী উপস্থিতি</a>
                                            </li>
                                            <li><a href="{{ url('/merit-list') }}">মেধা তালিকা</a></li>
                                            <li>
                                                <a href="{{ url('/current-students') }}">শিক্ষার্থী নীতিমালা</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="quick-link-box compact-box">
                                        ...
                                        <ul class="box-links">
                                            <li>
                                                <a href="{{ url('/public-results') }}">পাবলিক পরীক্ষার ফল</a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/internal-results') }}">অভ্যন্তরীণ পরীক্ষার ফলাফল</a>
                                            </li>
                            ...
                            <div class="about-content-wrapper">
                                <div class="about-content">
                                    ...
                                    <div class="about-footer">
                                        <a href="{{ url('/about') }}" class="read-more-btn">বিস্তারিত পড়ুন</a>
                                    </div>
                                </div>
                    ...
                    <section class="teachers-section">
                        <div class="container">
                            ...
                            <div class="teachers-slider owl-carousel">
                                ...
                                <div class="teacher-card box-shadow-effect">
                                    ...
                                    <div class="teacher-info">
                                        ...
                                        <a href="{{ url('/teacher-details') }}" class="teacher-btn">বিস্তারিত দেখুন</a>
                                    </div>
                                </div>
                            ...
                            <div class="section-footer">
                                <a href="{{ url('/teachers-info') }}" class="view-all-btn">সকল শিক্ষক দেখুন</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="committee-section">
                        <div class="container">
                                ...
                                <div class="committee-card box-shadow-effect">
                                    ...
                                    <div class="committee-info">
                                        ...
                                        <div class="member-details">
                                            ...
                                            <p><i class="fas fa-clock"></i> মেয়াদ: ১ জানুয়ারী, ২০ ২৭</p>
                                        </div>
                                        <div class="member-social">
                                            <a href="#"><i class="fas fa-phone"></i></a>
                                            <a href="#"><i class="fas fa-envelope"></i></a>
                            ...
                            <div class="section-footer">
                                <a href="{{ url('/management-committee') }}" class="view-all-btn">সকল সদস্য দেখুন</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="gallery-section">
                        <div class="container">
                            ...
                            <div class="section-footer">
                                <a href="{{ url('/gallery') }}" class="view-all-btn">সম্পূর্ণ গ্যালারি দেখুন</a>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="students-section">
                        <div class="container">
                            ...
                            <div class="section-footer">
                                <a href="{{ url('/merit-list') }}" class="view-all-btn">আরো দেখুন</a>
                            </div>
                        </div>
                    </section>
@endsection